        ...
        <div class="app-card alert alert-dismissible shadow-sm mb-4 border-left-decoration" role="alert">
            <div class="inner">
                <div class="app-card-body p-3 p-lg-4">
                    <h3 class="mb-3">Welcome {{ Auth::user()->firstname }}!</h3>
                    <div class="row gx-5 gy-3">
                        <div class="col-12 col-lg-10">
                            <div>
                                You are now logged into the OpenHAS dashboard. For both customers and employees this will look similar,
                                with the main difference being in the functionalities that both people have access to.
                                Is this the first time you are using OpenHAS? Then take a short tutorial by clicking on
                                the button on the right. Have fun with OpenHAS!
                            </div>
                        </div>
                        <!--//col-->
                        <div class="col-12 col-lg-2">
                            <a class="btn app-btn-primary" href="#tutorial">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-info-lg me-2" viewBox="0 0 16 16">
